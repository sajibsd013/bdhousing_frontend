<template>
  <div class="container my-3">
    ...
    <p>Welcome to Bangladesh Tax Digitization!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Bangladesh Tax Digitization's Website, located at
      https://bdhousingtax.com/.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Bangladesh Tax Digitization if you do not agree to
    ...
    <p>
      We employ the use of cookies. By accessing Bangladesh Tax Digitization,
      you agreed to use cookies in agreement with the Bangladesh Tax
      Digitization's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Bangladesh Tax Digitization and/or its licensors
      own the intellectual property rights for all material on Bangladesh Tax
      Digitization. All intellectual property rights are reserved. You may
      access this from Bangladesh Tax Digitization for your own personal use
      subjected to restrictions set in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Bangladesh Tax Digitization</li>
      <li>
        Sell, rent or sub-license material from Bangladesh Tax Digitization
      </li>
      <li>
        Reproduce, duplicate or copy material from Bangladesh Tax Digitization
      </li>
      <li>Redistribute content from Bangladesh Tax Digitization</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Bangladesh Tax
      Digitization does not filter, edit, publish or review Comments prior to
      their presence on the website. Comments do not reflect the views and
      opinions of Bangladesh Tax Digitization,its agents and/or affiliates.
      Comments reflect the views and opinions of the person who post their views
      and opinions. To the extent permitted by applicable laws, Bangladesh Tax
      Digitization shall not be liable for the Comments or for any liability,
    ...
    <p>
      Bangladesh Tax Digitization reserves the right to monitor all Comments and
    ...
    <p>
      You hereby grant Bangladesh Tax Digitization a non-exclusive license to
    ...
    <p>
      ...
      hyperlink compensates the absence of Bangladesh Tax Digitization; and (d)
    ...
    <p>
      ...
      e-mail to Bangladesh Tax Digitization. Please include your name, your
    ...
    <p>
      No use of Bangladesh Tax Digitization's logo or other artwork will be
...
export default {
  head() {
    return {
      title: "Bangladesh Tax Digitization || Terms & conditions ",
    };
  },
};
</script>
